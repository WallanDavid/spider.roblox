-- setup_spider_game.lua
-- Script de configuração automática do Spider Game para Roblox Studio
-- Cole este script no ServerScriptService e execute para configurar automaticamente

print("🕷️ Configurando Spider Game Demo automaticamente...")
...
local function setupSpiderGame()
    print("🕷️ Iniciando configuração automática do Spider Game...")
